...
GREETING_RESPONSES = ["'sup bro", "hey", "*nods*", "hey you get my snap?", "Don't wake the Kraken", "Greetings, my friend",]
...
NONE_RESPONSES = [
    ...
    "Morning Kraken friend, how do you do?",
...
SELF_VERBS_WITH_NOUN_CAPS_PLURAL = [
    ...
    "I am the best Kraken in the field of {noun}!",
...
SELF_VERBS_WITH_NOUN_LOWER = [
    ...
    "My Kraken dad is a {noun} expert."
]
